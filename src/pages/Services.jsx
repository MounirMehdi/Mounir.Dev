...
// Composant VideoThumbnail pour les projets
const VideoThumbnail = ({ src }) => {
  ...
  if (hasError || !videoSrc) {
    return (
      <div className="w-full h-64 flex items-center justify-center bg-gray-300 dark:bg-gray-600">
                  ...
                  >
                    ...
                    >
                      <div className="relative overflow-hidden flex-shrink-0">
                        {/* CORRECTION : Afficher project.img si disponible, sinon project.video */}
                        {project.img?.url ? (
                          <img
                            src={project.img.url}
